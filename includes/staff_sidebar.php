<?php
// $activePage should be set by the including page: 'dashboard' | 'daily' | 'report'
$activePage = $activePage ?? '';
$navItems = [
    'dashboard' => ['label' => 'Dashboard',        'href' => 'dashboard.php',      'icon' => 'home'],
    'daily'     => ['label' => "Today's Bookings",  'href' => 'daily_bookings.php', 'icon' => 'calendar'],
    'report'    => ['label' => 'Daily Report',      'href' => 'daily_report.php',   'icon' => 'chart'],
];
?>
<style>
    ...
    /* ---------- FIX: keep page content clear of the fixed hamburger ----------
       ...
       daily_bookings.php, or daily_report.php. */
...
<button type="button" class="sidebar-toggle" id="sidebarToggleBtn" onclick="toggleStaffSidebar()" aria-label="Toggle menu">
    <span class="bar"></span>
    <span class="bar"></span>
    <span class="bar"></span>
</button>
<div class="sidebar-backdrop" id="staffSidebarBackdrop" onclick="toggleStaffSidebar()"></div>
<div class="sidebar" id="staffSidebar">
    <div class="sidebar-inner">
        <div class="brand">Paddle<span>Staff</span></div>
        <nav>
...
<script>
    function toggleStaffSidebar() {
        document.getElementById('staffSidebar').classList.toggle('collapsed');
        document.getElementById('sidebarToggleBtn').classList.toggle('active');
        document.getElementById('staffSidebarBackdrop').classList.toggle('visible');
    }
